...
diff:	file_reader.o graph_create.o global.o calc_expr.o differen.o create_node.o rec_parsing.o tokenizator.o main.o
	g++ -Wall -o bin/differentiator bin/file_reader.o bin/graph.o bin/global.o bin/main.o bin/calc_expr.o bin/differen.o bin/create_node.o bin/tokenizator.o bin/rec_parsing.o
...
create_node.o: src/create_node.cpp $(mh)
	g++ -Wall -g $(d) $(g) -c src/create_node.cpp -o bin/create_node.o
